...
// Turns a list of bools and an index into a pef
export function boolIndexToPeg(bools: Array<boolean>, index: number) {
	return bools.slice(0, index).filter(bool => bool).length
}
